module.exports = function toReadable (number) {
    ...
    let num20 = ["ten","eleven ", "twelve ", "thirteen ", "fourteen", "fifteen ", "sixteen ", "seventeen", "eighteen ", "nineteen "];
    ...
    if (numarr.length===1) {result = num1[number];} else if (numarr ==="0") {result = "zero";} else if (numarr ==="") {result = "";}
    ...
    else if (numarr.length===3){switch(true){
        case (numarr[1]===0):
        result = num100[numarr[0]]+num1[numarr[2]]; break;
        case (numarr[1]===1):
